...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/fortescue/lowvalueprtopo/config/test/integration/FirstJourney",
    "com/fortescue/lowvalueprtopo/config/test/integration/GeneralConfigListJourney",
    "com/fortescue/lowvalueprtopo/config/test/integration/GeneralConfigObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
